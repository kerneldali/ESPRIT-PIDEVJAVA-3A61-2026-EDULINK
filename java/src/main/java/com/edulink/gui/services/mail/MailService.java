...
public class MailService {
    ...
    private static final String FROM_EMAIL = "eya.makhlouf.isic@gmail.com";
    private static final String APP_PASSWORD = "baunvjikeeyfhqfy";
    ...
    public static boolean sendOtpEmail(String toEmail, String otp) {
        try {
            ...
            String html = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head>"
                    ...
                    + "<span style='font-size:36px;font-weight:bold;letter-spacing:8px;color:#6366f1;'>" + otp
                    + "</span></div>"
        ...
        try {
            ...
            for (String toEmail : resolveEmails(session.getTutorId(), session.getStudentId())) {
                ...
                String html = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head>"
                        ...
                        + "<p style='color:#555;'><strong>Duration:</strong> " + session.getDurationMinutes()
                        + " min</p>"
    ...
    private static String[] resolveEmails(int tutorId, int studentId) {
        ...
        try {
            java.sql.Connection c = com.edulink.gui.util.MyConnection.getInstance().getCnx();
