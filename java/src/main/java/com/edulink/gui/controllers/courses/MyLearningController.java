...
public class MyLearningController implements Initializable {
    ...
    private void loadData() {
        ...
        for (Enrollment e : enrollments) {
            ...
            Course course = allCourses.stream().filter(c -> c.getId() == e.getCoursId() && !"ARCHIVED".equalsIgnoreCase(c.getStatus()) && !"FORCE_ARCHIVED".equalsIgnoreCase(c.getStatus())).findFirst().orElse(null);
            if (course != null) {
