...
use App\Service\MotivationCoach;
...
class AiChallengeController extends AbstractController
{
    ...
    public function generateTasks(
        ...
        $tasksData = $aiService->generateTasks((string) $challenge->getTitle(), (string) $challenge->getGoal());
    ...
    #[Route('/motivation/{id}', name: 'admin_ai_motivation', methods: ['GET'])]
    public function getMotivation(
        \App\Entity\UserChallenge $userChallenge,
        MotivationCoach $coach
    ): JsonResponse {
        $message = $coach->getMotivationalMessage($userChallenge);
